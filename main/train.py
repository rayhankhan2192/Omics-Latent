...
#     # # Option 3: create_multi_input_classifier
#     # logger.info("Using Hybrid CNN-Attention Classifier.")
#     # num_views = len(data_tr_list)
#     # #latent_dim_per_view = config['latent_dim']
#     # latent_dim_per_view = train_latent_features_list[0].shape[1]
#     # classifier = models.create_multi_input_classifier(latent_dim_per_view, num_views, config['num_classes'])
